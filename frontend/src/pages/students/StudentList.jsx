...
const StudentList = () => {
  ...
  const handleShareLink = () => {
    ...
    const registrationUrl = `${baseUrl}/student-test?ref=${referralCode}`;
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              <thead className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
                <tr>
                  <th className="p-4 text-left font-semibold text-xs uppercase tracking-wider">Student ID</th>
              ...
              <tbody>
                {filteredStudents.map((student) => (
                  <tr key={student._id || student.id} className="border-b border-gray-300 hover:bg-gray-50 transition-colors">
                    <td className="p-4">
                      <span className="font-semibold text-indigo-600">{student.studentId || student.id || 'N/A'}</span>
                    </td>
                    <td className="p-4">
                    ...
                    <td className="p-4">
                      <span className="text-gray-600">{student.referredBy || 'N/A'}</span>
                    </td>
                    <td className="p-4">
