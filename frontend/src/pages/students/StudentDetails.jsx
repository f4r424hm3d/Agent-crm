...
const StudentDetails = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="sticky top-16 z-20 bg-gray-50/80 backdrop-blur-md py-4 transition-all border-b border-gray-200 -mx-6 px-6">
        <div className="flex flex-wrap gap-4 justify-center">
          {[
            ...
            <button
              ...
              className={`px-8 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 shadow-sm border ${activeTab === tab.id
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-36">
            ...
            <div className="px-6 pb-8">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-4 flex items-center gap-2.5">
                  <div className="bg-gray-100 p-1.5 rounded-lg">
                    <UserCircle2 className="w-4 h-4 text-gray-500" />
                  </div>
                  <span className="leading-tight text-sm font-bold">Referral Information</span>
                </h3>
                <div className="mt-4">
